...
int initialx = 3;
int initialy = 4;
double initialradius = 49;

int scale = 4;

int windowsize = 720;

sf::RenderWindow window(sf::VideoMode(windowsize,windowsize), "Problem 1");
...
//This function only serves to create the layout of the graph and the axises for the image
